    ...
    <div className="Servicios-container">
      ...
      <div className="servicios-cards">
        <div className="tipos-de-servicios">
          ...
          <p>
            Desabollado en frío sin dañar la pintura. Daños por granizo. Choques
            leves.
          </p>
        </div>
        <div className="tipos-de-servicios">
          ...
          <p>
            Tratamientos que garantizan un mayor brillo y protección de la
            pintura frente a polvo, lluvia, aves y rayos uv.
          </p>
        </div>
        <div className="tipos-de-servicios">
          <img src={img7}></img>
          ...
          <p>
            Limpieza profundo interior vehículos utilizando maquinaria y
        ...
        <div className="tipos-de-servicios">
          ...
          <p>
            Cursos intensivos y personalizados desde hace más de 4 años.
