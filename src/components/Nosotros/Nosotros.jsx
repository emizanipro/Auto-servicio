...
function Nosotros() {
  useEffect(() => {
    const fadeInElements = document.querySelectorAll(
      ".nosotros-img-izquierda, .nosotros-img-derecha"
    );
    ...
    <div className="Nosotros-container">
      ...
      <div className="nosotros-img-izquierda">
        ...
        <div>
          <h3>Trayectoria</h3>
          <p>
            Somos una empresa familiar mendocina con más de 14 años de
            trayectoria en el mercado. Siempre enfocados en ofrecerte las
            mejores soluciones de detallado, abrillantados, tratamientos de
            pintura y sellados para tu vehículo
          </p>
          <button>
      ...
      <div className="nosotros-img-derecha">
        ...
        <div>
          ...
          <p>
            Nos especializamos en tratamientos de pintura vehiculares,
            sacabollos y daño por granizo, limpieza de interiores, polarizados.
            También dictamos capacitaciones en Car Detail porque queremos que
            cada vez más personas puedan contar en sus autos con un "brillo
            perfecto".
          </p>
          <button>
      ...
      <div className="nosotros-img-izquierda">
        ...
        <div>
          <h3>Tienda Online</h3>
          <p>
            Contamos además con un amplio stock en productos para tu vehículo
            que podés encontrar visitando nuestra tienda. Las mejores marcas
            junto a su respectivo asesoramiento personalizado.
          </p>
          <button>
