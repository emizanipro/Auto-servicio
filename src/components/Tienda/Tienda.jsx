...
function Tienda() {
  ...
  const productosFiltrados = categoriaSeleccionada
    ? productos.filter(
        (producto) => producto.categoria_del_producto === categoriaSeleccionada
      )
    : [];
        ...
        if (productoExistente) {
          ...
          return [
            ...prevCarrito,
            {
              ...
              cantidad,
              total: parseFloat(
                (productoSeleccionado.precio_del_producto * cantidad).toFixed(2)
              ),
            },
          ];
        }
          ...
          if (item.id === id) {
            ...
            return nuevaCantidad > 0
              ? {
                  ...
                  total: parseFloat(
                    (nuevaCantidad * item.precio_del_producto).toFixed(2)
                  ),
                }
              : null;
          }
  ...
  return (
    <div className="Tienda-container">
        ...
        <div className="categorias-list">
          ...
          {categorias.map((categoria, index) => (
            <button
              key={index}
              className={
                categoria === categoriaSeleccionada ? "categoria-activa" : ""
              }
          ...
          {productosFiltrados.length > 0 ? (
            productosFiltrados.map((producto) => (
              ...
              >
                ...
                <img
                  src={producto.url_img_del_producto}
                  alt={producto.nombre_del_producto}
                />
      ...
      {overlayVisible && productoSeleccionado && (
        <div className="overlay-agregar-al-carrito">
          <div className="producto-detalles">
            <img
              src={productoSeleccionado.url_img_del_producto}
              alt={productoSeleccionado.nombre_del_producto}
            />
            ...
            <span>
              Precio Unidad ${" "}
              {formatPrice(productoSeleccionado.precio_del_producto)}
            </span>
      ...
      <div className="carrito-compras" onClick={handleAbrirCarrito}>
        <button>
          <img
            src="https://cdn-icons-png.flaticon.com/128/6737/6737614.png"
            width="50px"
            height="50px"
            alt="Carrito"
          ></img>
              ...
              <>
                ...
                <div className="carrito-total">
                  <h4>
                    Total a Pagar ${" "}
                    {formatPrice(
                      carrito.reduce((acc, item) => acc + item.total, 0)
                    )}
                  </h4>
                </div>
              </>
